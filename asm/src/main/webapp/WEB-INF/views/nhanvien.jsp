...
<div class="col-9 offset-3 p-0 position-relative">
    ...
    <div >
        ...
        <div>
            <div class="text-center mt-3"> <h5>nhân viên</h5></div>
            <div style="color: red">${tb}</div>
            <div class="ml-auto"><a href="/San-Pham/FormNhanVien" class="btn btn-success ">ADD</a></div>
            <table class="table">
                <thead>
                <tr>
                    <th scope="col">stt</th>
                ...
                <c:forEach var="list" items="${nv.content}" varStatus="i" >
                    <tr>
                        <td>${i.index}</td>
                        <td>${list.id}</td>
                        <td>${list.ten}</td>
                        ...
                        <td><a href="/San-Pham/update?idnv=${list.id}" class="btn btn-info ">sửa</a>
                            <a href="/San-Pham/xoa?idnv=${list.id}" class="btn btn-info ">xóa</a></td>
                    </tr>
                </c:forEach>
                <nav aria-label="Page navigation">
                    <ul class="pagination ">
                        <li class="page-item">
                            <a class="page-link" href="/San-Pham/NhanVien">về đầu</a>
                        </li>
                        <li class="page-item disabled">
                            <a class="page-link" href="#" tabindex="-1" aria-disabled="true">...</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/San-Pham/NhanVien?x=${nv.first ? 0 : nv.number - 1}">"<<<"</a>
                        </li>
                        <li class="page-item">
                        <li class="page-item">
                            <a class="page-link text-dark disabled" href="#">${nv.number + 1}</a>
                        </li>

                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/San-Pham/NhanVien?x=${nv.last ? nv.totalPages - 1 : sp.number + 1}">">>>"</a>
                        </li>
                        <li class="page-item disabled">
                            <a class="page-link" href="#" tabindex="-1" aria-disabled="true">...</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="/San-Pham/NhanVien?x=${nv.totalPages - 1}">${nv.totalPages}</a>
                        </li>
                    </ul>
                </nav>
                </tbody>
